...
//           {/* ✅ AGGIORNATA: Griglia con 6 campi invece di 4 */}
...
//                   value={assegnazioneForm.ordine || ''}
//                   onChange={(e) => updateAssegnazioneForm({ ordine: e.target.value })}
//                 />
//               </div>
//             </div>
...
//                 <input
//                   type="text"
//                   placeholder="es. RDT-ABC123"
//                   className="glass-input w-full p-4 rounded-2xl bg-transparent border-0 outline-none text-white placeholder-white/50"
//                   value={assegnazioneForm.rdt || ''}
//                   onChange={(e) => updateAssegnazioneForm({ rdt: e.target.value })}
//                 />
//               </div>
//             </div>
//           </div>
...
//                         {/* Form di Modifica Inline - ✅ AGGIORNATO con nuovi campi */}
//                         {editAssignmentId === assegnazione._id && (
//                           <div className="glass-edit-form mt-4 p-4 rounded-2xl">
//                             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
//                               <div className="glass-input-container">
...
//                               {/* ✅ NUOVO CAMPO: Ordine nella modifica */}
//                               <div className="glass-input-container">
//                                 <input
//                                   type="text"
//                                   placeholder="Numero Ordine"
//                                   className="glass-input w-full p-3 rounded-xl bg-transparent border-0 outline-none text-white text-sm placeholder-white/50"
//                                   value={editForm.ordine || ''}
//                                   onChange={(e) => updateEditForm({ ordine: e.target.value })}
//                                 />
//                               </div>

//                               {/* ✅ NUOVO CAMPO: RDT nella modifica */}
//                               <div className="glass-input-container">
//                                 <input
//                                   type="text"
...
//                                     <Hash className="w-3 h-3" />
//                                     <span className="text-xs">{assignment.ordine}</span>
//                                   </div>
//                                 )}
...
//                                     <Clipboard className="w-3 h-3" />
//                                     <span className="text-xs">{assignment.rdt}</span>
//                                   </div>
//                                 )}
//                               </div>
//                             ))

...
async function resetDatabase() {
  try {
    ...
    const prodottiData = [
      // DPI
      { nome: 'Guanti in lattice S', categoria: 'DPI', unita: 'scatole', descrizione: 'Scatola da 100 pz' },
      { nome: 'Guanti in lattice M', categoria: 'DPI', unita: 'scatole', descrizione: 'Scatola da 100 pz' },
      { nome: 'Guanti in lattice L', categoria: 'DPI', unita: 'scatole', descrizione: 'Scatola da 100 pz' },
      { nome: 'Mascherine FFP2', categoria: 'DPI', unita: 'confezioni', descrizione: 'Confezione da 20 pz' },
      { nome: 'Mascherine chirurgiche', categoria: 'DPI', unita: 'scatole', descrizione: 'Scatola da 50 pz' },
      { nome: 'Occhiali protettivi', categoria: 'DPI', unita: 'pz', descrizione: 'Protezione laterale' },
      { nome: 'Camici monouso', categoria: 'DPI', unita: 'pz', descrizione: 'TNT 30g/mq' },
      
      // Igiene
      { nome: 'Gel igienizzante 500ml', categoria: 'Igiene', unita: 'flaconi', descrizione: 'Alcol 70%' },
      { nome: 'Gel igienizzante 1L', categoria: 'Igiene', unita: 'flaconi', descrizione: 'Alcol 70%' },
      { nome: 'Sapone liquido', categoria: 'Igiene', unita: 'flaconi', descrizione: 'Flacone 500ml' },
      { nome: 'Carta asciugamani', categoria: 'Igiene', unita: 'pacchi', descrizione: 'Pacco da 150 fogli' },
      { nome: 'Carta igienica', categoria: 'Igiene', unita: 'confezioni', descrizione: 'Confezione da 4 rotoli' },
      
      // Pulizia
      { nome: 'Detergente pavimenti', categoria: 'Pulizia', unita: 'taniche', descrizione: 'Tanica 5L' },
      { nome: 'Detergente vetri', categoria: 'Pulizia', unita: 'flaconi', descrizione: 'Flacone 750ml' },
      { nome: 'Candeggina', categoria: 'Pulizia', unita: 'flaconi', descrizione: 'Flacone 1L' },
      { nome: 'Sgrassatore universale', categoria: 'Pulizia', unita: 'flaconi', descrizione: 'Flacone 750ml' },
      { nome: 'Sacchi spazzatura 70L', categoria: 'Pulizia', unita: 'rotoli', descrizione: 'Rotolo da 10 pz' },
      { nome: 'Sacchi spazzatura 110L', categoria: 'Pulizia', unita: 'rotoli', descrizione: 'Rotolo da 10 pz' },
      { nome: 'Spugne abrasive', categoria: 'Pulizia', unita: 'confezioni', descrizione: 'Confezione da 5 pz' },
      { nome: 'Panni microfibra', categoria: 'Pulizia', unita: 'confezioni', descrizione: 'Confezione da 3 pz' },
      
      // Attrezzature
      { nome: 'Scope', categoria: 'Attrezzature', unita: 'pz', descrizione: 'Scopa con manico' },
      { nome: 'Palette', categoria: 'Attrezzature', unita: 'pz', descrizione: 'Paletta con manico' },
      { nome: 'Mocio completo', categoria: 'Attrezzature', unita: 'pz', descrizione: 'Mocio + secchio' },
      { nome: 'Secchi', categoria: 'Attrezzature', unita: 'pz', descrizione: 'Secchio 10L' },
      { nome: 'Carrelli pulizia', categoria: 'Attrezzature', unita: 'pz', descrizione: 'Carrello multiuso' }
    ];
